<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="BirthDayTemplate.aspx.cs" Inherits="Templates_BirthDayTemplate" 
    ...
    <div class="Register">
        ...
        <div id="DivBirthTempBox">
            ...
            <table cellspacing="15">
                ...
                <tr>
                    <td valign="top">
                        <asp:Label ID="Label5" runat="server" Text="Email Body" CssClass="LoginLabel"></asp:Label>
                    </td>  
                     <td >
